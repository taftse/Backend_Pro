     ...
     class Settings extends Admin_Controller
     {
         ...
         function index()
         {
            ...
            $config['group'] = array(
                ...
                'members'     => array('name'=> $this->lang->line('preference_page_member_settings'), 'fields'=>'allow_user_registration,activation_method,account_activation_time,autologin_period,default_user_group,user_login_method,allow_user_profiles'),
            ...
            $config['field']['user_login_method'] = array('type'=>'dropdown','params'=>array('options'=>array('email'=>'Email','username'=>'Username','either'=>'Either')));
