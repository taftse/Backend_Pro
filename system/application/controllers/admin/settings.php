<?php if (!defined('BASEPATH')) exit('No direct script access allowed');  
     ...
     */      
     class Settings extends Admin_Controller
     {
         ...
         function index()
         {
            // Set setting options, e.g what type of eidl validation rules etc
            
            // Set groups, if a single group is specifyed, all options must belong to a group
            // otherwise groups arn't needed
